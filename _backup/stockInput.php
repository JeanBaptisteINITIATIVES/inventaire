...
?>
		...
		<section id="products-area">
			<div class="container">	
				...
				<table class="table table-striped table-bordered nowrap" id="table-stock-input" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th>Date</th>
							<th>Emplacement</th>
					...
					<tbody>
						<?php 
							foreach ( $list_input as $list )
							{
								...
								echo	'<td>
											<button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-change" data-backdrop="false" data-id="' . $list['id'] . '" data-tooltip="tooltip" data-placement="top" title="Modifier"><span class="glyphicon glyphicon-pencil"></span></button>
											<button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-delete" data-backdrop="false" data-id="' . $list['id'] . '" data-tooltip="tooltip" data-placement="top" title="Supprimer"><span class="glyphicon glyphicon-remove"></span></button>
										</td>
									</tr>';
							}
						?>
